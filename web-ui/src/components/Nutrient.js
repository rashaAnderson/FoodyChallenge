...
export default class Users extends React.Component {
  ...
  async findMaxNutrientAmount(id) {
    ...
    //let maxNutrientServing = this.findMaxValue(nutrientData, nutrientData.amountPerServing);
  ...
  findMaxValue(data, compareId) {
    let reducedArray = data.reduce((data,b)=>data[compareId]>b[compareId]?data:b); 
    return reducedArray;
  }
  ...
  render() {
    ...
    return (
      <div>
        ...
        weekly Amount: {this.state.nutrients.foodId}  <br />
        </p>
      </div>
    )
  }
